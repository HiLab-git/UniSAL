...
class Tumor_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"img":transformed["image"], "label":label, 'img_name':image_path}
...
class Tumor_dataset_two_weak(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"img1":image_w1, "img2":image_w2, "label":cls_label, "img_name":image_path}
...
class Tumor_dataset_two_weak_rcc(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"img1":image_w1, "img2":image_w2, "p_label":p_label, "img_name":image_path}
...
class Tumor_dataset_FM(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"img_w":image_w, "img_s":image_s, "label":cls_label, "img_name":image_path}
...
class Tumor_dataset_taal(Dataset):
    def __init__(self, args, files):
        ...
        self.train_transform_w3 = A.Compose(
            [
                A.SmallestMaxSize(max_size=args.input_size),
                A.RandomCrop(height=args.crop_size, width=args.crop_size),
                # A.ShiftScaleRotate(shift_limit=0.05, scale_limit=0.05, rotate_limit=15),
    ...
    def __getitem__(self, index):
        ...
        image_w1 = self.train_transform_w1(image=image)["image"]
        image_w2 = self.train_transform_w2(image=image)["image"]
        image_w3 = self.train_transform_w3(image=image)["image"]

        return {"img1":image_w1, "img2":image_w2, "img3":image_w3, "label":cls_label, "img_name":image_path}
